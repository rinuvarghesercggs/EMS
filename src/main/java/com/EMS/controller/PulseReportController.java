...
public class PulseReportController {
	...
	private static String[] pReportHeading= {"Consultant","Hire Date","Emp. Type","Client","Project Name","PM","Revenue/ Location","CPP Level","Start Date","End Date","Billing Type",};
	...
	private static String[] termheading= {"Termination Date","Consultant","Employee Type","CPP Level","Start Date","Term Type","Termination Reason","No. Of Days","Yrs of Service"};
	...
	public void pulseReport(@RequestBody JsonNode requestData,HttpServletResponse response) throws Exception {
		...
		pulsereportservice.generateReport(userbook,pReportHeading,pulsedata);
